...
| Authentication  | [v0.3](features/0.3-authentication.md) — `FR-AUTH-001`–`034` | pending                                                                       | pending                                                                                                              | Spec drafted |
| Shopping Cart   | [v0.4](features/0.4-shopping-cart.md) — `FR-CART-001`–`025`  | pending                                                                       | pending                                                                                                              | Spec drafted |
| Orders          | [v0.5](features/0.5-orders.md) — `FR-ORD-001`–`027`          | pending                                                                       | pending                                                                                                              | Spec drafted |
