...
// lifetime stats, reusing orders.repository.ts's lifetimeStatsForUser (whose
// orderIds this then feeds into payments.repository.ts's sumRefundsForOrders
// to net refunds out of lifetimeAmountSpent — the identical net-of-refunds
// treatment getSalesSummary gives the admin dashboard's own revenue figure).
